    <form class="form-signin" method="POST" action="php/loginUser.php">
        ...
        <p id="sInP">New to <img id="sInLogo" src="img/logo_v6.png" alt=""/>?<a data-dismiss="modal" href="index.php?c=2">Sign Up</a></p>
    </form>